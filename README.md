...
- **Graphing** (still being moved over from the [original implementation of the Desmos macro](https://github.com/colbyn/subscript/blob/master/src/macros.rs#L258), unless you use e.g. [this plugin](https://github.com/subscript-publishing/subscript/blob/master/examples/school-notes/plugins/desmos1.rhai).):
  ```html
  <desmos>
      <expr>y = x^2</expr>
  </desmos>
